        ...
        <div class="Contenido-interfaz">
            <div class="emergente">
                ...
                <div class="emergente__opciones">
                    <button type="button" name="R-calificaciones"class="emergente__opciones-botones"><a href="../Docente/Registrar_Asistencia.php" class="lemerge">REGRESAR A REGISTRO DE ASISTENCIA</a></button>

                    <button type="button" name="R-calificaciones"class="emergente__opciones-botones"><a href="../Docente/Gestion_Cursos.php" class="lemerge">REGRESAR A GESTIÓN DE CURSOS</a></button>

                    <button type="button" name="R-calificaciones"class="emergente__opciones-botones"><a href="../Docente/Interfaz_Docente.php" class="lemerge">IR
                        AL MENÚ PRINCIPAL
                    </a></button>
