            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="Gestion_Cursos.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/Gestion_.png" class="img-interacciones"></a>
                        <p>GESTIÓN DE CURSOS</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="Observar_Cursos.php"><img src="../Imagenes/Iconos-Menu-Docente/observador.png" alt="" class="img-interacciones" ></a>
