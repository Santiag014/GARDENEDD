            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="./Observador_Estudiante.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/pila-de-libros-de-tres.png" class="img-interacciones"></a>
                        <p>CURSO 1</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="./Observador_Estudiante.php"><img src="../Imagenes/Iconos-Menu-Docente/pila-de-libros-de-tres.png" alt="" class="img-interacciones" ></a>
                        <p>CURSO 2</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="./Observador_Estudiante.php"><img src="../Imagenes/Iconos-Menu-Docente/pila-de-libros-de-tres.png" alt="" class="img-interacciones" ></a>
