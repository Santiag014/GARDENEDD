            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="Registrar_Asistencia.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/asistencia.png" class="img-interacciones"></a>
                        <p>REGISTRAR ASISTENCIA</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="Registro_Calificaciones.php"><img src="../Imagenes/Iconos-Menu-Docente/calificaciones-de-los-estudiantes.png" alt="" class="img-interacciones" ></a>
                        <p>INGRESAR CALIFICACIONES</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="Planillas_Cursos.php"><img src="../Imagenes/Iconos-Menu-Docente/planilla.png" alt="" class="img-interacciones" ></a>
                        <p>PLANILLAS</p>
                    </div>
                </div>
