        ...
        <div class="Contenido-interfaz">
            ...
            <div class="Container-ReporteCalificaciones-Estudiante">
                ...
                <div class="btn-registro">
                    <button class="regresar-reporte-cal"><img src="../Imagenes/Iconos-Menu-Docente/back.svg" alt=""width="15px" class="img-btn">REGRESAR</button>
                    <button class="guardar-reporte-cal"><img src="../Imagenes/Iconos-Menu-Docente/save.svg" alt="" width="15px" class="img-btn">GUARDAR</button>
                </div>
