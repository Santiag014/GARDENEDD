            ...
            <div class="contenedor-int">
                ...
                <div class="contenedor-tabla">
                    <table id="registro_asist" border=1 class="table bordertablas">     
                            ...
                            <tbody>
                                <tr>
                                    <td class="reduccionoptima">XXXXXXXXXXXXXXXXXXXXXXXXXXX</td>
                                    <td>
                                        <select name="fecha1estudiante1" class="borderbotons textoterciario reduccionoptima">
                                    ...
                                    <td>
                                        <select name="fecha2estudiante1" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha3estudiante1" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha4estudiante1" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha5estudiante1" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                ...
                                <tr>
                                    <td class="reduccionoptima">XXXXXXXXXXXXXXXXXXXXXXXXXXX</td>
                                    <td>
                                        <select name="fecha1estudiante2" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha2estudiante2" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha3estudiante2" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha4estudiante2" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                                    ...
                                    <td>
                                        <select name="fecha5estudiante2" class="borderbotons textoterciario reduccionoptima">
                                            <option value="SINSELECCION"></option>
                                            <option value="ASISTENCIA">ASISTIÓ</option>
                                            <option value="NO">NO ASISTIÓ</option>
                                            <option value="RETRASO">RETRASO</option>
                ...
                <div class="botones">
                    ...
                    <div class="botones__guardar">
                        <button type="submit" value="REGISTRAR" class="registro">
                            <a href="Emrgente_Registrar_Asistencia_Directivo.php" class="lemerge">REGISTRAR</a>
                        </button>   
