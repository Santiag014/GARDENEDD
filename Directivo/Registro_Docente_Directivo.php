            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="Ingresar_Docente_Directivo.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/Ingresar_Docente.png" class="img-interacciones"></a>
                        <p>INGRESAR DOCENTE</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="Gestionar_Usuarios_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/Gestionar_Docente.png" alt="" class="img-interacciones" ></a>
