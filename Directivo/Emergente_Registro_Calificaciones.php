        ...
        <div class="Contenido-interfaz">
            <div class="emergente">
                ...
                <div class="emergente__opciones">
                    <button type="button" name="R-calificaciones"class="emergente__opciones-botones"><a href="Registro_Calificaciones_Directivo.php" class="lemerge">REGRESAR A REGISTRO DE CALIFICACIONES</a></button>

                    <button type="button" name="R-calificaciones"class="emergente__opciones-botones"><a href="Gestion_Cursos_Directivo.php" class="lemerge">REGRESAR A GESTIÓN DE CURSOS</a></button>

                    <button type="button" name="R-calificaciones"class="emergente__opciones-botones"><a href="Interfaz_Directivo.php" class="lemerge">IR AL MENÚ INICIAL</a></button>
