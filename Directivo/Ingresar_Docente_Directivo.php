    ...
    <div class="Container-principal">
        ...
        <div class="Contenido-interfaz">
            ...
            <div class="container_ingdocente">
                ...
                <div class="container__ingdocente-h3"><h3>USUARIO #123456789</h3></div>
                ...
                <div class="separar">
                    <button type="submit" class="Button-save-AddStuden" onclick="save_IngresarDocenteDirectivo()"><img src="../Imagenes/Iconos-Menu-Docente/save.svg" alt="" style="margin-bottom: -3px; margin-right: 5px;" width="18px" ;>GUARDAR</button>
                    <button class="Button-cancel-AddStuden" onclick="btnCancel_IngresarDocenteDirectivo()"><img src="../Imagenes/Iconos-Menu-Docente/cancel.svg" alt="" style="margin-bottom: -3px; margin-right: 5px;" width="18px"; >CANCELAR</button>
                </div>
