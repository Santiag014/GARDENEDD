            ...
            <div class="cambiar-foto">
                ...
                <div class="buttons-cambiar-foto">
                  <button class="boton-cambio-perfil-1" type="submit">
                    ...
                    CAMBIAR FOTO</button>
                  <button class="boton-cambio-perfil-2" type="submit" onclick="EliminarFoto_PagCambiarFoto()">
                    <img src="../Imagenes/Iconos-Menu-Docente/eliminar.png" class="img-Cambiar-Foto">
                    ELIMINAR FOTO</button>
                  <button class="boton-cambio-perfil-regresar" type="submit" onclick="redireccionarRegresar_PagCambiarFoto()">
