...
<body>
    <div class="Container-principal">
        ...
        <div class="Contenido-interfaz">
            ...
            <div class="Registro-Matriculas-Directivo">
                <div class="h3-RegistroMatricula-Directivo">
                    <h3>REGISTRO DE MATRÍCULA</h3>
                </div>
    
                <div class="Container-RegistroMatricula-Directivo">
                    <div class="ContainerTable-RegistroMatricula-Directivo">

                        <div class="h4-Container-RegistroMatricula-Directivo">
                            <div class="h4-info">
                                <h4>CURSO: </h4>
                                <p>Xxxxxxxx</p>
                            </div>
                        ...
                        <div class="table-RegistroMatricula-Directivo">
                            <table class="Container_Table_RegistroMatricula" border="3">
                                <thead>
                              ...
                              <tbody>
                                  <tr class="tr_body_table">
                                      ...
                                      <th>Activo</th>
                                      <th><a href="./Observar_Registro_Matrícula_DIrectivo.php"><img src="../Imagenes/Iconos-Menu-Docente/lupa.svg" alt="" class="img_table_observador"></a></th>
                                      <th><a href="./Editar_Registro_Matricula_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/edit.svg" alt="" class="img_table_observador"></a></th>
                                  </tr>
                                  <tr class="tr_body_table">
                                      <th class="nombre_table">XXXX XXXXXX XXXX</th>
                                      <th>Activo</th>
                                  ...
                                  <tr class="tr_body_table">
                                      ...
                                      <th class="nombre_table">XXXX XXXXXX XXXX</th>
                                      <th>Activo</th>
                                      <th><a href="./Observador_Estudiante_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/lupa.svg " alt="" class="img_table_observador"></a></th>
                                      <th><a href="./Observador_Estudiante_Matricula.php"><img src="../Imagenes/Iconos-Menu-Docente/edit.svg" alt="" class="img_table_observador"></a></th>
                                  </tr>
                        ...
                        <div class="btn-RegistroMatricula-Directivo">
                            <button class="btn-regresar-RegistroMatricula" onclick="btn_back_SeleccionCurso()"> <img src="../Imagenes/Iconos-Menu-Docente/back.svg" alt="" width="15px" style="margin-right: 5px;">REGRESAR</button>
                        </div>
                    </div>
    
                    <div class="footer-RegistroMatricula">
