        ...
        <div class="Usuario-interfaz" >
            ...
            <div class="Img-Usuario-Interfaz">
                <img src="../Imagenes/img-usuario.png" alt="" class="Img-Usuario">
                   <?php include '../Validacion_DashBoard.php';?>
                <h5><?php echo $nombresUsuario . " " .$apellidosUsuario ; ?></h5>
            </div>
            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="./Gestion_Cursos_Directivo.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/Gestion_.png" class="img-interacciones"></a>
                        <p>GESTIÓN DE CURSOS</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="Registro_Matricula_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/nota.png" alt="" class="img-interacciones" ></a>
                        <p>REGISTRO DE MATRÍCULA</p>
                    </div>
                    <div class="ObservadorEstudiantil-Interfaz">
                        <a href="Observador_Cursos.php"><img src="../Imagenes/Iconos-Menu-Docente/observador.png"  class="img-interacciones"></a>
                        <p>OBSERVADOR ESTUDIANTIL</p>
                    </div>
                    <div class="RegistroDocente-Interfaz">
                        <a href="Registro_Docente_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/Registro_Docente.png" alt="" class="img-interacciones"></a>
