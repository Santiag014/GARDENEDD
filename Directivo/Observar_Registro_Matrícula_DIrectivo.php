        ...
        <div class="Contenido-interfaz">
            ...
            <div class="Container-Observar-rgistro-directivo">
                ...
                <div class="btn-MatriculaDirectivo">
                    <button class="btn-Regresar-MatriculaDirectivo" onclick="btn_back_ObservarRegistro()"><img src="../Imagenes/Iconos-Menu-Docente/back.svg" alt="" width="15px" style="margin-right: 5px;">REGRESAR</button>
                </div>
