            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="Ingresar_Estudiante_Directivo.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/NewStudent.png" class="img-interacciones"></a>
                        <p>INGRESAR NUEVO ESTUDIANTE</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="GestionEstudinate_Cursos_Directivo.php" class="Interacciones_Interfaz"   ><img src="../Imagenes/Iconos-Menu-Docente/GestionarStudent.png" alt="" class="img-interacciones" ></a>
                        <p>GESTIONAR ESTUDIANTE </p>
                    </div>
                </div>
