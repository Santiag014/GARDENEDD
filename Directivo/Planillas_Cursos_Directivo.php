            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="Planilla_Asistencia_Directivo.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/asistencia.png" class="img-interacciones"></a>
                        <p>OBSERVAR ASISTENCIA</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="Planilla_Calificaciones_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/calificaciones-de-los-estudiantes.png" alt="" class="img-interacciones" ></a>
                        <p>OBSERVAR CALIFICACIONES</p>
                    </div>
                </div>
