    ...
    <div class="Container-principal">
        ...
        <div class="Contenido-interfaz">
            ...
            <div class="Container-AddStudent">
                ...
                <div class="h5_Matricula_AddStudent">
                    <h5>INFORMACIÓN DE ACUDIENTE</h5>
              </div>
                ...
                <div class="Informacion_Acud_AddStudent">
                    ...
                    <div class="Caja_Informacion_AddStudent">
                        <label for="numero_documento">úmero de Documento</label>
                         <input type="text" name="numero_documento" id="numero_documento" >
                    </div>
                ...
                <div class="Botones_AddStudent">
                    <button class="Button-save-AddStuden" onclick="saveDatos_EditarRegistroMatricula()"><img src="../Imagenes/Iconos-Menu-Docente/save.svg" alt="" style="margin-bottom: -3px; margin-right: 5px;" width="18px" ;>GUARDAR</button>
                    <button class="Button-cancel-AddStuden" onclick="btnBack_EditarRegistroMatricula()" ><img src="../Imagenes/Iconos-Menu-Docente/cancel.svg" alt="" style="margin-bottom: -3px; margin-right: 5px;" width="18px"; >CANCELAR</button>
                    <button class="Button-eliminarRegistro"onclick="BtnEliminar_EditarRegistroMatricula()"><img src="../Imagenes/Iconos-Menu-Docente/cancel.svg" alt="" style="margin-bottom: -3px; margin-right: 5px;" width="18px"; >ELIMINAR REGISTRO</button>
                </div>
