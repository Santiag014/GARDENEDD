            ...
            <div class="Contenido-Interfaz-Administrativo-Principal">
                ...
                <div class="Interacciones-Interfaz-Admninistrativo">
                    <div class="GestionCursos-Interfaz">
                        <a href="./Gestionar_Table_Docente_Directivo.php" class="Interacciones_Interfaz"><img src="../Imagenes/Iconos-Menu-Docente/Docente.png" class="img-interacciones"></a>
                        <p>DOCENTE</p>
                    </div>
                    <div class="RegistroMatricula-Interfaz">
                        <a href="./Gestionar_Table_Directivo_Directivo.php"><img src="../Imagenes/Iconos-Menu-Docente/directivos.png" alt="" class="img-interacciones" ></a>
                        <p>DIRECTIVOS</p>
                    </div>
                </div>
